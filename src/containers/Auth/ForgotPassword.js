          ...
          <div className="loginBox forgotBox">
            ...
            >
              ...
              <div className="btnCon text-center">
                {/*<Button color="primary" className="mainBtn" disabled={isDisable()}>Send password reset link</Button>*/}
                <Button color="primary" type="button" className="mainBtn" onClick={() => props.history.push('/companyprofile')}>Send password reset link</Button>
              </div>
              <p className="loginTextNew"><a onClick={() => props.history.push('/')}>Back to Sing In</a></p>
            </ValidatorForm>
          </div>
        </div>
      </div>
